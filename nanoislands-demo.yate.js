...
(function() {
    ...
    var j75 = [ 0, 'orientation' ];

    var j76 = [ 0, 'handle', 0, 'class' ];
    ...
    var j97 = [ 0, 'attrsInput' ];

    var j98 = [ 0, 'countMax' ];

    var j99 = [ 0, 'source' ];

    var j100 = [ 0, 'highlight' ];

    var j101 = [ 0, 'classSuggest' ];
    ...
    var j104 = [ 2, p1, 0, 'item' ];

    var j105 = [ 0, 'labelContent' ];

    function p2(m, c0, i0, l0) {
        return cmpSN("username", selectNametest('type', c0, []));
    }

    var j106 = [ 2, p2, 0, 'item' ];

    var j107 = [ 0, 'size' ];

    var j108 = [ 0, 'usernameHighlighted' ];

    var j109 = [ 0, 'emailHighlighted' ];
    ...
    var j111 = [ 0, 'user', 2, p3, 0, 'username' ];

    var j112 = [ 1, 1, 0, 'usernameHighlighted' ];

    function p4(m, c0, i0, l0) {
        return cmpSN("suggest", selectNametest('mod', c0, [])) && simpleBoolean('emailHighlighted', c0);
    }

    var j113 = [ 0, 'user', 2, p4, 0, 'email' ];

    var j114 = [ 1, 1, 0, 'emailHighlighted' ];

    var j115 = [ 0, 'toggler' ];

    var j116 = [ 0, 'leftText' ];

    var j117 = [ 0, 'rightText' ];
    ...
    M.t9 = function t9(m, c0, i0, l0, a0) {
        ...
        var r1 = '';
        var a1 = { a: {} };
        if ((cmpSN("pseudo", selectNametest('theme', c0, [])))) {
            r1 += "s";
        } else {
        ...
        r0 += "</select>";
        r0 += "<div class=\"" + "nb-select__dropdown nb-select__dropdown_size_" + scalar2attrvalue( ( v112 ) ) + " nb-select_theme_" + nodeset2attrvalue( ( selectNametest('theme', c0, []) ) ) + "\"></div>";
        r0 += "</span>";
    ...
    M.t10 = function t10(m, c0, i0, l0, a0) {
        ...
        a0.a = {
            ...
            'for': new yr.scalarAttr("nb-checkbox_" + ( v113 ))
        };
        a0.s = 'label';
        r0 += m.a(m, m.s(j5, c0), 'nb-main-attrs', a0)
        if (simpleBoolean('disabled', c0)) {
        ...
        a0.a = {
            ...
            'id': new yr.scalarAttr("nb-checkbox_" + ( v113 ))
        };
        a0.s = 'input';
        if (simpleBoolean('name', c0)) {
            a0.a[ "name" ] = new yr.scalarAttr(simpleScalar('name', c0));
    ...
    M.t22 = function t22(m, c0, i0, l0, a0) {
        ...
        if (nodeset2boolean( m.s(j76, c0) )) {
            var tmp0 = a0.a[ "class" ];
            if (tmp0) {
                a0.a[ "class" ] = tmp0.addscalar(" " + nodeset2scalar( ( m.s(j76, c0) ) ));
            } else {
                a0.a[ "class" ] = new yr.scalarAttr(" " + nodeset2scalar( ( m.s(j76, c0) ) ));
            }
        }
        r0 += closeAttrs(a0);
        r0 += "<span class=\"" + "nb-button__text" + "\">";
    ...
    M.t24 = function t24(m, c0, i0, l0, a0) {
        ...
        if (!(cmpSN("true", selectNametest('search', c0, [])))) {
            ...
            r0 += m.f('f11', c0, i0, l0, a0, yr.object2nodeset( v115 ));
            r0 += "</div>";
    ...
    M.t25 = function t25(m, c0, i0, l0, a0) {
        ...
        if (cmpSN("true", selectNametest('services', c0, []))) {
            ...
            a0.s = 'div';
            r0 += m.a(m, m.n(j24, yr.object2nodeset( v118 )), 'nb', a0)
            r0 += closeAttrs(a0);
            r0 += "</div>";
            r0 += "</div>";
        }
    ...
    M.t29 = function t29(m, c0, i0, l0, a0) {
        ...
        r0 += m.a(m, m.s(j5, c0), 'nb-main-attrs', a0)
        r0 += closeAttrs(a0);
        r0 += m.f('f11', c0, i0, l0, a0, yr.object2nodeset( v119 ));
        r0 += "</div>";
    ...
    M.t32 = function t32(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f23', c0, i0, l0, a0, yr.object2nodeset( v120 ));
    ...
    M.t36 = function t36(m, c0, i0, l0, a0) {
        ...
        r0 += m.f('f10', c0, i0, l0, a0, yr.object2nodeset( v122 ));
        r0 += "</div>";
        r0 += "</div>";
