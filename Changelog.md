...
###### Fixes
fix #493 — Устаревший jquery-ui (обновить до версии 1.11.x)
fix #494 — нельзя передать в where попапа массив с координатами
fix #492 — проблемы с хинтом в инпуте

##### 0.6.8 — path

###### Fixes
* fix #459 — Добавить в документацию для попапа параметр how.fixed
* fix #483 — Невозможно указать using для окна
* fix #487 — Сломался radio-button
