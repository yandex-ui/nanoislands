...
(function() {
    ...
    M.f49 = function f49(m, c0, i0, l0, a0) {
        ...
        r0 += m.f('f35', c0, i0, l0, a0, "loader-w", v80);
    ...
    var j48 = [ 0, 'titleContent' ];

    var j49 = [ 0, 'modalPopup' ];

    var j50 = [ 0, 'buttons' ];

    var j51 = [ 0, 'radio-button' ];
    ...
    M.t7 = function t7(m, c0, i0, l0, a0) {
        ...
        if (nodeset2boolean( m.s(j41, c0) )) {
            a0.a[ "accept" ] = new yr.scalarAttr(nodeset2scalar( ( m.s(j41, c0) ) ));
        }
        r0 += closeAttrs(a0);
        r0 += '';
    ...
    M.t13 = function t13(m, c0, i0, l0, a0) {
        ...
        for (var i1 = 0, l1 = items0.length; i1 < l1; i1++) {
            var c1 = items0[ i1 ];
            //  var uniq : scalar
            var v81 = "nb-radio-button_" + ( (yr.externals['_nb-uniq'])() );
            ...
            a0.a = {
                ...
                'name': new yr.scalarAttr(nodeset2scalar( ( m.s(j53, c1) ) )),
            ...
            r0 += m.f('f4', c1, i1, l1, a0, (yr.externals['_nb-extend'])(m.s(j14, c1), yr.object2nodeset((function() {
                ...
                r0[ "static" ] = true;
                r0[ "id" ] = false;
                r0[ "size" ] = yr.nodeset2data(m.s(j55, c1));
                var r1 = {};
                var a1 = { a: {} };
                r1[ "for" ] = v81;
    ...
    M.t14 = function t14(m, c0, i0, l0, a0) {
        ...
        for (var i1 = 0, l1 = items0.length; i1 < l1; i1++) {
            var c1 = items0[ i1 ];
            if ((v82 && simpleBoolean('selected', c1)) || (!v82 && i1 == 0)) {
    ...
    M.t16 = function t16(m, c0, i0, l0, a0) {
        ...
        a0.a = {
            ...
            'for': new yr.scalarAttr("nb-checkbox_" + ( v83 ))
        };
        a0.s = 'label';
        r0 += m.a(m, 0, m.s(j14, c0), 'nb-main-attrs', a0)
        m.f('f2', c0, i0, l0, a0, yr.object2nodeset((function() {
        ...
        a0.a = {
            ...
            'id': new yr.scalarAttr("nb-checkbox_" + ( v83 ))
        };
        a0.s = 'input';
    ...
    M.t17 = function t17(m, c0, i0, l0, a0) {
        ...
        if (simpleBoolean('error', c0)) {
            a0.a[ "data-nb-error" ] = new yr.scalarAttr("{ \"id\": \"" + ( v84 ) + "\", \"direction\":\"" + nodeset2scalar( ( m.s(j66, c0) ) ) + "\"}");
        }
        r0 += closeAttrs(a0);
        if (simpleBoolean('error', c0)) {
            r0 += m.f('f9', c0, i0, l0, a0, yr.object2nodeset((function() {
                var r0 = {};
                var a0 = { a: {} };
                r0[ "class" ] = nodeset2scalar( m.s(j67, c0) ) + " _nb-error-popup";
    ...
    M.t18 = function t18(m, c0, i0, l0, a0) {
        ...
        //  var errorId : scalar
        var v85 = "nb-input_error" + (yr.externals['_nb-uniq'])();
        ...
        if (simpleBoolean('error', c0)) {
            ...
            a0.a[ "data-nb-error" ] = new yr.scalarAttr("{ \"id\": \"" + ( v85 ) + "\", \"direction\":\"" + nodeset2scalar( ( m.s(j66, c0) ) ) + "\" }");
            r0 += closeAttrs(a0);
            r0 += m.f('f9', c0, i0, l0, a0, yr.object2nodeset((function() {
                var r0 = {};
                var a0 = { a: {} };
    ...
    M.t24 = function t24(m, c0, i0, l0, a0) {
        ...
        var tmp0 = a0.a[ "class" ];
        if (tmp0) {
            a0.a[ "class" ] = tmp0.addscalar("nb-island _nb" + ( v87 ) + ( v86 ) + "-island");
        } else {
            a0.a[ "class" ] = new yr.scalarAttr("nb-island _nb" + ( v87 ) + ( v86 ) + "-island");
        }
        r0 += closeAttrs(a0);
        if (simpleBoolean('content', c0)) {
            r0 += simpleScalar('content', c0);
    ...
    M.t28 = function t28(m, c0, i0, l0, a0) {
        ...
        //  var prefix : scalar
        var v88 = "tabs-" + ( (yr.externals['_nb-uniq'])() );
        ...
        for (var i1 = 0, l1 = items0.length; i1 < l1; i1++) {
            ...
            r0 += closeAttrs(a0);
            r0 += "<a class=\"" + "_nb-tabs-link _link" + "\" href=\"" + "#" + scalar2attrvalue( ( v88 ) ) + "-" + scalar2attrvalue( ( i1 ) ) + "\">";
        ...
        for (var i1 = 0, l1 = items0.length; i1 < l1; i1++) {
            var c1 = items0[ i1 ];
            r0 += "<div class=\"" + "_nb-tabs-panel" + "\" id=\"" + scalar2attrvalue( ( v88 ) ) + "-" + scalar2attrvalue( ( i1 ) ) + "\">";
    ...
    M.t39 = function t39(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f30', c0, i0, l0, a0, yr.object2nodeset( v91 ));
    ...
    M.t52 = function t52(m, c0, i0, l0, a0) {
        ...
        //  var itemLast : scalar
        var v92 = ( selectNametest('types', c0, []) ).length - 1;
