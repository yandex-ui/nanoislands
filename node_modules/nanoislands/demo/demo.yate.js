...
(function() {
    ...
    M.f106 = function f106(m, c0, i0, l0, a0) {
        ...
        r0 += m.f('f34', c0, i0, l0, a0, m.f('f28', c0, i0, l0, a0, yr.object2nodeset((function() {
            var r0 = {};
            var a0 = { a: {} };
            var r1 = {};
            var a1 = { a: {} };
            ...
            var r2 = '';
            var a2 = { a: {} };
            r2 += m.a(m, 0, [ c0.doc.root ], 'test', a2)
            r1[ "content" ] = r2;
            r0[ "auth" ] = r1;
    ...
    M.f108 = function f108(m, c0, i0, l0, a0) {
        ...
        a0.a[ "data-source" ] = new yr.scalarAttr(nodeset2scalar( m.n(j28, yr.object2nodeset( v108 )) ));
        r0 += closeAttrs(a0);
        r0 += '';
        r0 += "</div>";
    ...
    var j51 = [ 0, 'close', 0, 'class' ];

    var j52 = [ 0, 'close', 0, 'attrs' ];

    var j53 = [ 0, 'close', 0, 'attrs', 0, '*' ];

    var j54 = [ 0, 'buttons' ];

    var j55 = [ 0, 'radio-button' ];
    ...
    var j70 = [ 0, 'error', 0, 'direction' ];

    var j71 = [ 0, 'hint', 0, 'text' ];

    var j72 = [ 0, 'hint', 0, 'ghost' ];

    var j73 = [ 0, 'error', 0, 'content' ];
    ...
    var j90 = [ 0, 'orientation' ];

    var j91 = [ 0, 'handle', 0, 'class' ];
    ...
    var j97 = [ 0, 'buttonTabindex' ];

    var j98 = [ 0, 'buttonContent' ];

    var j99 = [ 0, 'inputTabindex' ];
    ...
    var j101 = [ 0, 'arrow', 2, p1 ];

    function p2(m, c0, i0, l0) {
        return simpleBoolean('href', c0);
    }

    var j102 = [ 0, 'arrow', 2, p1, 2, p2 ];

    var j103 = [ 0, 'header' ];

    var j104 = [ 0, 'settings' ];

    var j105 = [ 0, 'settings', 0, 'content' ];

    var j106 = [ 0, 'services' ];

    var j107 = [ 0, 'services', 0, 'content' ];

    var j108 = [ 0, 'auth', 0, 'content' ];

    var j109 = [ 0, 'user' ];

    var j110 = [ 0, 'user', 0, 'content' ];
    ...
    var j121 = [ 0, 'highlight' ];

    var j122 = [ 0, 'classSuggest' ];

    var j123 = [ 0, 'attrsInput' ];
    ...
    var j125 = [ 2, p3, 0, 'item' ];

    function p4(m, c0, i0, l0) {
        return cmpSN("username", selectNametest('type', c0, []));
    }

    var j126 = [ 2, p4, 0, 'item' ];

    var j127 = [ 0, 'size' ];

    var j128 = [ 0, 'usernameHighlighted' ];

    var j129 = [ 0, 'emailHighlighted' ];
    ...
    var j131 = [ 0, 'user', 2, p5, 0, 'username' ];

    var j132 = [ 1, 1, 0, 'usernameHighlighted' ];

    function p6(m, c0, i0, l0) {
        return cmpSN("suggest", selectNametest('mod', c0, [])) && simpleBoolean('emailHighlighted', c0);
    }

    var j133 = [ 0, 'user', 2, p6, 0, 'email' ];

    var j134 = [ 1, 1, 0, 'emailHighlighted' ];

    var j135 = [ 0, 'toggler' ];

    var j136 = [ 0, 'leftText' ];

    var j137 = [ 0, 'rightText' ];
    ...
    M.t11 = function t11(m, c0, i0, l0, a0) {
        ...
        for (var i1 = 0, l1 = items0.length; i1 < l1; i1++) {
            ...
            a0.a = {
                ...
                'name': new yr.scalarAttr(nodeset2scalar( ( m.s(j57, c1) ) )),
            ...
            r0 += m.f('f4', c1, i1, l1, a0, (yr.externals['_nb-extend'])(m.s(j14, c1), yr.object2nodeset((function() {
                ...
                r0[ "static" ] = true;
                r0[ "id" ] = false;
                r0[ "size" ] = yr.nodeset2data(m.s(j59, c1));
                var r1 = {};
                var a1 = { a: {} };
                r1[ "for" ] = v115;
    ...
    M.t15 = function t15(m, c0, i0, l0, a0) {
        ...
        if (simpleBoolean('error', c0)) {
            a0.a[ "data-nb-error" ] = new yr.scalarAttr("{ \"id\": \"" + ( v118 ) + "\", \"direction\":\"" + nodeset2scalar( ( m.s(j70, c0) ) ) + "\"}");
        }
        r0 += closeAttrs(a0);
        ...
        if (simpleBoolean('error', c0)) {
            r0 += m.f('f9', c0, i0, l0, a0, yr.object2nodeset((function() {
                ...
                r0[ "content" ] = yr.nodeset2data(m.s(j73, c0));
                r0[ "id" ] = v118;
    ...
    M.t16 = function t16(m, c0, i0, l0, a0) {
        ...
        if (simpleBoolean('error', c0)) {
            ...
            a0.a[ "data-nb-error" ] = new yr.scalarAttr("{ \"id\": \"" + ( v119 ) + "\", \"direction\":\"" + nodeset2scalar( ( m.s(j70, c0) ) ) + "\" }");
            r0 += closeAttrs(a0);
            r0 += m.f('f9', c0, i0, l0, a0, yr.object2nodeset((function() {
                var r0 = {};
                var a0 = { a: {} };
    ...
    M.t25 = function t25(m, c0, i0, l0, a0) {
        ...
        if (nodeset2boolean( m.s(j91, c0) )) {
            var tmp0 = a0.a[ "class" ];
            if (tmp0) {
                a0.a[ "class" ] = tmp0.addscalar(" " + nodeset2scalar( ( m.s(j91, c0) ) ));
            } else {
                a0.a[ "class" ] = new yr.scalarAttr(" " + nodeset2scalar( ( m.s(j91, c0) ) ));
            }
        }
        if ((simpleBoolean('tabindex', c0) && !simpleBoolean('disabled', c0))) {
            a0.a[ "tabindex" ] = new yr.scalarAttr(simpleScalar('tabindex', c0));
    ...
    M.t30 = function t30(m, c0, i0, l0, a0) {
        ...
        if (simpleBoolean('user', c0)) {
            if (nodeset2boolean( m.s(j110, c0) )) {
    ...
    M.t37 = function t37(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f29', c0, i0, l0, a0, yr.object2nodeset( v125 ));
