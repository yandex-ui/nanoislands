...
(function() {
    ...
    var j94 = [ 0, 'buttonTabindex' ];

    var j95 = [ 0, 'buttonContent' ];

    var j96 = [ 0, 'inputTabindex' ];
    ...
    var j98 = [ 0, 'arrow', 2, p1 ];

    function p2(m, c0, i0, l0) {
        return simpleBoolean('href', c0);
    }

    var j99 = [ 0, 'arrow', 2, p1, 2, p2 ];

    var j100 = [ 0, 'header' ];

    var j101 = [ 0, 'settings' ];

    var j102 = [ 0, 'settings', 0, 'content' ];

    var j103 = [ 0, 'services' ];

    var j104 = [ 0, 'services', 0, 'content' ];

    var j105 = [ 0, 'auth', 0, 'content' ];

    var j106 = [ 0, 'user' ];

    var j107 = [ 0, 'user', 0, 'content' ];
    ...
    var j118 = [ 0, 'highlight' ];

    var j119 = [ 0, 'classSuggest' ];

    var j120 = [ 0, 'attrsInput' ];
    ...
    var j122 = [ 2, p3, 0, 'item' ];

    function p4(m, c0, i0, l0) {
        return cmpSN("username", selectNametest('type', c0, []));
    }

    var j123 = [ 2, p4, 0, 'item' ];

    var j124 = [ 0, 'size' ];

    var j125 = [ 0, 'usernameHighlighted' ];

    var j126 = [ 0, 'emailHighlighted' ];
    ...
    var j128 = [ 0, 'user', 2, p5, 0, 'username' ];

    var j129 = [ 1, 1, 0, 'usernameHighlighted' ];

    function p6(m, c0, i0, l0) {
        return cmpSN("suggest", selectNametest('mod', c0, [])) && simpleBoolean('emailHighlighted', c0);
    }

    var j130 = [ 0, 'user', 2, p6, 0, 'email' ];

    var j131 = [ 1, 1, 0, 'emailHighlighted' ];

    var j132 = [ 0, 'toggler' ];

    var j133 = [ 0, 'leftText' ];

    var j134 = [ 0, 'rightText' ];
    ...
    M.t15 = function t15(m, c0, i0, l0, a0) {
        ...
        if (simpleBoolean('error', c0)) {
            a0.a[ "data-nb-error" ] = new yr.scalarAttr("{ \"id\": \"" + ( v115 ) + "\", \"direction\":\"" + nodeset2scalar( ( m.s(j67, c0) ) ) + "\"}");
        }
        r0 += closeAttrs(a0);
        if (simpleBoolean('error', c0)) {
