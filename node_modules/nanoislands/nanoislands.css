...
.nb-select-dropdown ._nb-select-group-item > ._nb-select-a > ._nb-select-text:before,
...
.is-selected ._nb-select-text:after,
...
.nb-input-group .nb-input:first-child:not(:only-child) > .nb-input-input, .nb-input-group .nb-input:first-child:not(:only-child) > .nb-input-input:before,
...
.nb-input-group .nb-input:last-child:not(:only-child) > .nb-input-input, .nb-input-group .nb-input:last-child:not(:only-child) > .nb-input-input:before,
...
._nb-popup ._nb-popup-link:hover, ._nb-popup ._nb-popup-link:focus {
  background: rgba(255,193,0,0.37);
}
._nb-popup ._nb-popup-link:first-child {
  margin-top: 5px;
}
._nb-popup ._nb-popup-link:last-child {
  margin-bottom: 5px;
}
...
._nb-default-popup ._nb-popup-title {
...
._nb-default-popup ._nb-popup-content {
  padding: 0;
}
._nb-default-popup ._nb-popup-buttons {
  margin-top: -1px;
...
._nb-small-select-dropdowns ._nb-select-item ._nb-select-text {
  font-size: 13px;
  line-height: 18px;
  padding: 3px 10px;
}
._nb-small-normal-select .ui-state-focus > ._nb-select-text,
...
._nb-m-attention-icon {
  background-image: url("blocks/icon/attention.svg");
  width: 32px;
  height: 32px;
}
._nb-m-three-dots-icon {
  background-image: url("blocks/icon/three-dots.svg");
  width: 32px;
  height: 32px;
}
...
._nb-m-link-white-icon {
  background-image: url("blocks/icon/link-white.svg");
  width: 32px;
  height: 32px;
}
._nb-m-download-white-icon {
  background-image: url("blocks/icon/download-white.svg");
  width: 32px;
  height: 32px;
}
._nb-m-upload-white-icon {
  background-image: url("blocks/icon/upload-white.svg");
  width: 32px;
  height: 32px;
}
._nb-m-trash-white-icon {
  background-image: url("blocks/icon/trash-white.svg");
  width: 32px;
  height: 32px;
}
...
.nb-input-group .nb-input:not(:first-child):not(:last-child) > .nb-input-input, .nb-input-group .nb-input:not(:first-child):not(:last-child) > .nb-input-input:before {
  border-radius: 0 !important;
}
.nb-island {
  position: relative;
...
._nb-user_justify .nb-user-avatar {
  position: absolute;
  top: 0;
}
