...
(function() {
    ...
    M.f2 = function f2(m, c0, i0, l0, a0, v4) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f0', c0, i0, l0, a0, "popup-jq", (yr.externals['nb-extend'])(yr.object2nodeset( v5 ), v4));
    ...
    M.f38 = function f38(m, c0, i0, l0, a0) {
        ...
        r0 += "</span>";
        r0 += "</div>";
        r0 += m.f('f18', c0, i0, l0, a0, m.f('f8', c0, i0, l0, a0, yr.object2nodeset( v62 )));
        r0 += "</div>";
    ...
    M.f42 = function f42(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f6', c0, i0, l0, a0, yr.object2nodeset( v66 ));
    ...
    M.f44 = function f44(m, c0, i0, l0, a0) {
        ...
        r0 += "Кнопка+поле";
        r0 += "</div>";
        r0 += m.f('f18', c0, i0, l0, a0, m.f('f7', c0, i0, l0, a0, yr.object2nodeset( v68 )));
        r0 += "</div>";
    ...
    M.f50 = function f50(m, c0, i0, l0, a0) {
        ...
        r0 += "</span>";
        r0 += "</div>";
        r0 += m.f('f18', c0, i0, l0, a0, m.f('f48', c0, i0, l0, a0));
        r0 += "</div>";
    ...
    var j21 = [ 0, 'popup-jq', 0, 'id' ];

    var j22 = [ 0, 'popup-jq', 0, 'modal' ];

    var j23 = [ 0, 'popup-jq', 0, 'menu' ];
    ...
    var j37 = [ 0, 'button', 2, p7, 0, 'checked' ];
    ...
    var j44 = [ 0, 'select', 0, 'items', 2, p8 ];

    var j45 = [ 0, 'select', 0, 'size' ];

    var j46 = [ 0, 'select', 0, 'theme' ];

    var j47 = [ 0, 'select', 0, 'disabled' ];

    var j48 = [ 0, 'select', 2, p3 ];

    var j49 = [ 0, 'checkbox' ];

    var j50 = [ 0, 'input' ];

    var j51 = [ 0, 'input', 0, 'size' ];

    var j52 = [ 0, 'input', 0, 'disabled' ];

    var j53 = [ 0, 'input', 0, 'readonly' ];

    var j54 = [ 0, 'input', 0, 'maxlength' ];

    var j55 = [ 0, 'input', 0, 'length' ];

    var j56 = [ 0, 'input', 0, 'placeholder' ];

    var j57 = [ 0, 'input', 0, 'type' ];

    var j58 = [ 0, 'input', 0, 'name' ];

    var j59 = [ 0, 'input-group' ];

    var j60 = [ 0, 'progress' ];

    var j61 = [ 0, 'progress', 0, 'type' ];

    var j62 = [ 0, 'progress', 0, 'id' ];

    var j63 = [ 0, 'progress', 0, 'start' ];

    var j64 = [ 0, 'progress', 0, 'bar' ];

    var j65 = [ 0, 'start' ];

    var j66 = [ 0, 'progress', 0, 'title' ];
    ...
    var j68 = [ 0, 'progress', 0, 'title', 4, p9 ];

    function p10(m, c0, i0, l0) {
        return simpleBoolean('icon', c0);
    }

    var j69 = [ 0, 'icon', 2, p10 ];

    var j70 = [ 0, 'paranja' ];

    var j71 = [ 0, 'paranja', 0, 'theme' ];

    var j72 = [ 0, 'island' ];

    var j73 = [ 0, 'island', 0, 'padding' ];

    var j74 = [ 0, 'island', 0, 'inline' ];

    var j75 = [ 0, 'dropzone' ];

    var j76 = [ 0, 'dropzone', 0, 'mod' ];

    var j77 = [ 0, 'dropzone', 0, 'button' ];
    ...
    var j79 = [ 0, 'dropzone', 2, p11 ];

    var j80 = [ 0, 'dropzone', 0, 'head' ];

    var j81 = [ 0, 'dropzone', 0, 'text' ];

    var j82 = [ 1, 1, 0, 'button' ];

    function p12(m, c0, i0, l0) {
        return !(cmpSN("false", [ c0 ]));
    }

    var j83 = [ 0, 'dropzone', 0, 'button', 2, p12 ];

    var j84 = [ 0, 'loader' ];

    var j85 = [ 0, 'slider' ];

    var j86 = [ 0, 'track', 0, 'class' ];

    var j87 = [ 0, 'interval', 0, 'class' ];

    var j88 = [ 0, 'knob', 0, 'type' ];

    var j89 = [ 0, 'knob', 0, 'class' ];

    var j90 = [ 0, 'range', 0, 'class' ];

    var j91 = [ 0, 'dialog' ];

    var j92 = [ 0, 'theme' ];

    var j93 = [ 0, 'dialog', 0, 'id' ];
    ...
    M.t87 = function t87(m, c0, i0, l0, a0) {
        ...
        r0 += nodeset2xml( [ c0 ] );
        r0 += m.a(m, m.s(j82, c0), 'nb-content', a0)
        r0 += "</div>";
    ...
    M.t90 = function t90(m, c0, i0, l0, a0) {
        ...
        r0 += m.a(m, [ c0 ], 'nb-main-attrs', a0)
        r0 += closeAttrs(a0);
        r0 += "<span class=\"" + "nb-slider__track " + nodeset2attrvalue( ( m.s(j86, c0) ) ) + "\">";
        r0 += "<span class=\"" + "nb-slider__full" + "\"></span>";
        r0 += "<span class=\"" + "nb-slider__interval " + nodeset2attrvalue( ( m.s(j87, c0) ) ) + "\" style=\"" + "width: " + nodeset2attrvalue( ( selectNametest('value', c0, []) ) ) + "%" + "\"></span>";
        r0 += "</span>";
    ...
    M.t91 = function t91(m, c0, i0, l0, a0) {
        ...
        var r1 = {};
        var a1 = { a: {} };
        r1[ "class" ] = "nb-slider__knob nb-slider__knob_" + nodeset2scalar( ( m.s(j88, c0) ) ) + " nb-slider__knob_size_" + nodeset2scalar( ( selectNametest('size', c0, []) ) ) + " " + nodeset2scalar( ( m.s(j89, c0) ) );
        var r2 = {};
        var a2 = { a: {} };
        ...
        r0 += closeAttrs(a0);
        r0 += "<div class=\"" + "nb-slider__range nb-slider__range_size_" + nodeset2attrvalue( ( selectNametest('size', c0, []) ) ) + " " + nodeset2attrvalue( ( m.s(j90, c0) ) ) + "\">";
        r0 += m.f('f1', c0, i0, l0, a0, yr.object2nodeset( v79 ));
        r0 += "</div>";
    ...
    M.t102 = function t102(m, c0, i0, l0, a0) {
        ...
        r0 += m.f('f5', c0, i0, l0, a0, yr.object2nodeset( v81 ));
        r0 += "</div>";
        r0 += "</div>";
