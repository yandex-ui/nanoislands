...
(function() {
    ...
    M.f65 = function f65(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f16', c0, i0, l0, a0, yr.object2nodeset( v87 ));
    ...
    M.f66 = function f66(m, c0, i0, l0, a0) {
        ...
        r0 += "</div>";
        r0 += m.f('f24', c0, i0, l0, a0, m.f('f65', c0, i0, l0, a0));
        r0 += "</div>";
    ...
    M.f71 = function f71(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f17', c0, i0, l0, a0, yr.object2nodeset( v89 ));
    ...
    M.f72 = function f72(m, c0, i0, l0, a0) {
        ...
        r1 += closeAttrs(a1);
        r1 += m.f('f9', c0, i0, l0, a1, yr.object2nodeset( v90 ));
        var v91 = r1;
        ...
        r1 += closeAttrs(a1);
        r1 += m.f('f9', c0, i0, l0, a1, yr.object2nodeset( v92 ));
        var v93 = r1;
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f17', c0, i0, l0, a0, yr.object2nodeset( v94 ));
        r0 += "</div>";
    ...
    M.f79 = function f79(m, c0, i0, l0, a0) {
        ...
        r0 += "</div>";
        r0 += m.f('f24', c0, i0, l0, a0, m.f('f19', c0, i0, l0, a0, yr.object2nodeset( m.v('v99', c0) )));
        r0 += "</div>";
    ...
    M.f81 = function f81(m, c0, i0, l0, a0) {
        ...
        r0 += "</div>";
        r0 += m.f('f21', c0, i0, l0, a0, yr.object2nodeset( v107 ));
        r0 += "</div>";
    ...
    var j61 = [ 0, 'handle', 0, 'type' ];

    var j62 = [ 0, 'handle', 0, 'class' ];
    ...
    var j82 = [ 0, 'user', 0, 'username' ];

    var j83 = [ 0, 'user', 0, 'email' ];

    var j84 = [ 0, 'suggest' ];

    var j85 = [ 0, 'attrsInput' ];
    ...
    M.t10 = function t10(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += "<label class=\"" + "nb-checkbox nb-checkbox_size_" + nodeset2attrvalue( ( selectNametest('size', c0, []) ) ) + " nb-checkbox_type_" + nodeset2attrvalue( ( selectNametest('type', c0, []) ) ) + "\" for=\"" + scalar2attrvalue( ( v109 ) ) + "\">";
        r0 += "<input";
        a0.a = {
        ...
        r0 += closeAttrs(a0);
        r0 += '';
        r0 += "<span class=\"" + "nb-checkbox__flag" + "\"></span>";
    ...
    M.t20 = function t20(m, c0, i0, l0, a0) {
        ...
        r0 += "<a";
        a0.a = {
            'class': new yr.scalarAttr("nb-slider__handle nb-button nb-button_size_" + nodeset2scalar( ( selectNametest('size', c0, []) ) ) + " nb-button_theme_" + nodeset2scalar( ( selectNametest('theme', c0, []) ) ) + " nb-slider__handle_type_" + nodeset2scalar( ( m.s(j61, c0) ) ) + " ui-slider-handle")
        };
        a0.s = 'a';
        if (nodeset2boolean( m.s(j62, c0) )) {
            var tmp0 = a0.a[ "class" ];
            if (tmp0) {
                a0.a[ "class" ] = tmp0.addscalar(" " + nodeset2scalar( ( m.s(j62, c0) ) ));
            } else {
                a0.a[ "class" ] = new yr.scalarAttr(" " + nodeset2scalar( ( m.s(j62, c0) ) ));
            }
        }
        r0 += closeAttrs(a0);
    ...
    M.t22 = function t22(m, c0, i0, l0, a0) {
        ...
        if (!(cmpSN("true", selectNametest('search', c0, [])))) {
            ...
            r0 += m.f('f8', c0, i0, l0, a0, yr.object2nodeset( v111 ));
            r0 += "</div>";
    ...
    M.t23 = function t23(m, c0, i0, l0, a0) {
        ...
        if (cmpSN("true", selectNametest('services', c0, []))) {
            ...
            a0.s = 'div';
            r0 += m.a(m, m.n(j15, yr.object2nodeset( v114 )), 'nb', a0)
            r0 += closeAttrs(a0);
            r0 += "</div>";
            r0 += "</div>";
        }
    ...
    M.t29 = function t29(m, c0, i0, l0, a0) {
        ...
        r0 += m.a(m, [ c0 ], 'nb-main-attrs', a0)
        r0 += closeAttrs(a0);
        r0 += m.f('f8', c0, i0, l0, a0, yr.object2nodeset( v115 ));
        r0 += "</div>";
    ...
    M.t32 = function t32(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f20', c0, i0, l0, a0, yr.object2nodeset( v116 ));
    ...
    M.t35 = function t35(m, c0, i0, l0, a0) {
        ...
        r0 += m.f('f7', c0, i0, l0, a0, yr.object2nodeset( v118 ));
        r0 += "</div>";
        r0 += "</div>";
