...
(function() {
    ...
    var j91 = [ 0, 'slider', 0, 'theme' ];

    var j92 = [ 0, 'slider', 0, 'orientation' ];

    var j93 = [ 0, 'slider', 0, 'handle', 0, 'type' ];

    var j94 = [ 0, 'slider', 0, 'handle', 0, 'class' ];

    var j95 = [ 0, 'dialog' ];

    var j96 = [ 0, 'dialog', 0, 'id' ];
