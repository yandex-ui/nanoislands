...
(function() {
    ...
    M.f20 = function f20(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f6', c0, i0, l0, a0, yr.object2nodeset( v36 ));
    ...
    M.f21 = function f21(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f6', c0, i0, l0, a0, yr.object2nodeset( v37 ));
    ...
    M.f34 = function f34(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f7', c0, i0, l0, a0, yr.object2nodeset( v51 ));
        r0 += "<br/>";
        r0 += m.f('f7', c0, i0, l0, a0, yr.object2nodeset( v52 ));
    ...
    M.f35 = function f35(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f7', c0, i0, l0, a0, yr.object2nodeset( v53 ));
        r0 += "<br/>";
    ...
    M.f43 = function f43(m, c0, i0, l0, a0) {
        ...
        r0 += m.f('f18', c0, i0, l0, a0, m.f('f4', c0, i0, l0, a0, yr.object2nodeset( v62 )));
        r0 += "</div>";
        r0 += m.f('f4', c0, i0, l0, a0, yr.object2nodeset( v62 ));
        r0 += "</div>";
    ...
    M.f44 = function f44(m, c0, i0, l0, a0) {
        ...
        r0 += "</span>";
        r0 += "</div>";
        r0 += m.f('f19', c0, i0, l0, a0, m.f('f10', c0, i0, l0, a0, yr.object2nodeset( v63 )));
        r0 += "</div>";
        r0 += "<div class=\"" + "demo-section" + "\">";
        r0 += "<div class=\"" + "demo-h3" + "\">";
        r0 += "Type: Title ";
        ...
        r0 += "</span>";
        r0 += "</div>";
        r0 += m.f('f19', c0, i0, l0, a0, m.f('f10', c0, i0, l0, a0, yr.object2nodeset( v64 )));
        r0 += "</div>";
    ...
    M.f45 = function f45(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f8', c0, i0, l0, a0, yr.object2nodeset( v65 ));
    ...
    M.f50 = function f50(m, c0, i0, l0, a0) {
        ...
        r0 += "Поле+кнопка";
        r0 += "</div>";
        r0 += m.f('f19', c0, i0, l0, a0, m.f('f9', c0, i0, l0, a0, yr.object2nodeset( v69 )));
        r0 += "</div>";
        r0 += "<div class=\"" + "demo-section" + "\">";
        r0 += "<div class=\"" + "demo-h3" + "\">";
        r0 += "Кнопка+поле";
        r0 += "</div>";
        r0 += m.f('f19', c0, i0, l0, a0, m.f('f9', c0, i0, l0, a0, yr.object2nodeset( v70 )));
        r0 += "</div>";
    ...
    M.f55 = function f55(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f15', c0, i0, l0, a0, yr.object2nodeset( v74 ));
    ...
    M.f56 = function f56(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f15', c0, i0, l0, a0, yr.object2nodeset( v75 ));
    ...
    M.f60 = function f60(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f16', c0, i0, l0, a0, yr.object2nodeset( v78 ));
    ...
    M.f61 = function f61(m, c0, i0, l0, a0) {
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f16', c0, i0, l0, a0, yr.object2nodeset( v79 ));
    ...
    M.f62 = function f62(m, c0, i0, l0, a0) {
        ...
        r0 += "</div>";
        r0 += m.f('f19', c0, i0, l0, a0, m.f('f61', c0, i0, l0, a0));
        r0 += "</div>";
    ...
    var j34 = [ 0, 'radio-button', 0, 'group' ];
    ...
    var j40 = [ 0, 'button', 2, p8 ];

    var j41 = [ 0, 'name' ];

    var j42 = [ 0, 'checked' ];

    var j43 = [ 0, 'button', 2, p8, 0, 'checked' ];
    ...
    var j51 = [ 0, 'select', 0, 'items', 2, p9 ];

    var j52 = [ 0, 'select', 0, 'size' ];

    var j53 = [ 0, 'select', 0, 'theme' ];

    var j54 = [ 0, 'select', 0, 'disabled' ];

    var j55 = [ 0, 'select', 2, p4 ];

    var j56 = [ 0, 'checkbox' ];

    var j57 = [ 0, 'input' ];

    var j58 = [ 0, 'input', 0, 'size' ];

    var j59 = [ 0, 'input', 0, 'disabled' ];

    var j60 = [ 0, 'input', 0, 'readonly' ];

    var j61 = [ 0, 'input', 0, 'maxlength' ];

    var j62 = [ 0, 'input', 0, 'length' ];

    var j63 = [ 0, 'input', 0, 'placeholder' ];

    var j64 = [ 0, 'input', 0, 'type' ];

    var j65 = [ 0, 'input', 0, 'name' ];

    var j66 = [ 0, 'input-group' ];

    var j67 = [ 0, 'progress' ];

    var j68 = [ 0, 'progress', 0, 'type' ];

    var j69 = [ 0, 'progress', 0, 'id' ];

    var j70 = [ 0, 'progress', 0, 'start' ];

    var j71 = [ 0, 'progress', 0, 'bar' ];

    var j72 = [ 0, 'start' ];

    var j73 = [ 0, 'progress', 0, 'title' ];
    ...
    var j75 = [ 0, 'progress', 0, 'title', 4, p10 ];

    function p11(m, c0, i0, l0) {
        return simpleBoolean('icon', c0);
    }

    var j76 = [ 0, 'icon', 2, p11 ];

    var j77 = [ 0, 'paranja' ];

    var j78 = [ 0, 'paranja', 0, 'theme' ];

    var j79 = [ 0, 'island' ];

    var j80 = [ 0, 'island', 0, 'padding' ];

    var j81 = [ 0, 'island', 0, 'type' ];

    var j82 = [ 0, 'dropzone' ];

    var j83 = [ 0, 'dropzone', 0, 'mod' ];

    var j84 = [ 0, 'dropzone', 0, 'button' ];
    ...
    var j86 = [ 0, 'dropzone', 2, p12 ];

    var j87 = [ 0, 'dropzone', 0, 'head' ];

    var j88 = [ 0, 'dropzone', 0, 'text' ];

    var j89 = [ 1, 1, 0, 'button' ];

    function p13(m, c0, i0, l0) {
        return !(cmpSN("false", [ c0 ]));
    }

    var j90 = [ 0, 'dropzone', 0, 'button', 2, p13 ];
    ...
    var j95 = [ 0, 'slider', 0, 'size' ];

    var j96 = [ 0, 'slider', 0, 'value' ];

    var j97 = [ 0, 'slider', 0, 'id' ];

    var j98 = [ 0, 'slider', 0, 'theme' ];

    var j99 = [ 0, 'slider', 0, 'orientation' ];

    var j100 = [ 0, 'slider', 0, 'handle', 0, 'type' ];

    var j101 = [ 0, 'slider', 0, 'handle', 0, 'class' ];

    function p14(m, c0, i0, l0) {
        return cmpSN("myButton", selectNametest('mod', c0, []));
    }

    var j102 = [ 0, 'button', 2, p14 ];
    ...
    M.t23 = function t23(m, c0, i0, l0, a0) {
        ...
        var r1 = {};
        var a1 = { a: {} };
        r1[ "size" ] = yr.nodeset2data(m.s(j35, c0));
        r1[ "theme" ] = yr.nodeset2data(m.s(j36, c0));
        r1[ "class" ] = simpleScalar('class', c0) + " js-button";
        r1[ "type" ] = yr.nodeset2data(m.s(j37, c0));
        r1[ "name" ] = yr.nodeset2data(m.s(j38, c0));
        r1[ "mod" ] = "radio-button";
        var r2 = {};
        var a2 = { a: {} };
        ...
        r0 += closeAttrs(a0);
        r0 += m.f('f1', c0, i0, l0, a0, (yr.externals['nb-extend'])(yr.object2nodeset( v80 ), [ c0 ]));
    ...
    M.t24 = function t24(m, c0, i0, l0, a0) {
        ...
        //  var uniq : scalar
        var v81 = "nb-radio-button_" + ( (yr.externals['nb-uniq'])() );
    ...
    M.t35 = function t35(m, c0, i0, l0, a0) {
        ...
        //  var uniq : scalar
        var v82 = "nb-checkbox_" + ( (yr.externals['nb-uniq'])() );

        r0 += closeAttrs(a0);
        r0 += "<label class=\"" + "nb-checkbox nb-checkbox_size_" + nodeset2attrvalue( ( selectNametest('size', c0, []) ) ) + "\" for=\"" + scalar2attrvalue( ( v82 ) ) + "\">";
        r0 += "<input";
        a0.a = {
            'class': new yr.scalarAttr("nb-checkbox__input"),
            'type': new yr.scalarAttr(nodeset2scalar( ( selectNametest('type', c0, []) ) )),
            'id': new yr.scalarAttr(( v82 ))
        };
        a0.s = 'input';
        r0 += m.a(m, [ c0 ], 'nb-main-attrs', a0)
        r0 += closeAttrs(a0);
    ...
    M.t79 = function t79(m, c0, i0, l0, a0) {
        ...
        r0 += nodeset2xml( [ c0 ] );
        r0 += m.a(m, m.s(j89, c0), 'nb-content', a0)
        r0 += "</div>";
    ...
    M.t82 = function t82(m, c0, i0, l0, a0) {
        ...
        r0 += m.a(m, m.s(j94, c0), 'nb-attrs', a0)
        r0 += closeAttrs(a0);
    ...
    M.t94 = function t94(m, c0, i0, l0, a0) {
        ...
        r0 += m.f('f7', c0, i0, l0, a0, yr.object2nodeset( v83 ));
        r0 += "</div>";
        r0 += "<div class=\"" + "demo-toggle__section demo-toggle__section_second" + "\">";
        r0 += m.f('f7', c0, i0, l0, a0, yr.object2nodeset( v84 ));
        r0 += "</div>";
        r0 += "</div>";
